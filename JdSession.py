...
DEFAULT_TIMEOUT = 10
DEFAULT_USER_AGENT = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Safari/537.36 Edg/112.0.1722.48"
...
class Session(object):
        ...
        for i in range(15):
            payload = {
                ...
                "body": {
                    ...
                    # "shopId": "1000001952",
                    # "venderId": 1000001952,
                    # "paramJson": '{"platform2":"1","specialAttrStr":"p0pp1pppppppp1ppppppppppppp","skuMarkStr":"00"}',
                    "num": 1,
                },
            }
            # url = f"https://api.m.jd.com/?client=pc&clientVersion=1.0.0&t=1682095499766&body=%7B%22skuId%22%3A100055452449%2C%22cat%22%3A%229987%2C653%2C655%22%2C%22area%22%3A%2222_1930_49322_49423%22%2C%22shopId%22%3A%221000001952%22%2C%22venderId%22%3A1000001952%2C%22paramJson%22%3A%22%7B%5C%22platform2%5C%22%3A%5C%221%5C%22%2C%5C%22specialAttrStr%5C%22%3A%5C%22p0pp1pppppppp1ppppppppppppp%5C%22%2C%5C%22skuMarkStr%5C%22%3A%5C%2200%5C%22%7D%22%2C%22num%22%3A1%7D&uuid=122270672.1682083603645945876354.1682083604.1682085913.1682094015.3&appid=pc-item-soa&functionId=pc_detailpage_wareBusiness"

            payload_url = urlencode(payload)
            url = "https://api.m.jd.com/?" + payload_url
            # print(payload_url)
            header = {
                # ":authority": "api.m.jd.com",
                # ":method": "GET",
                # ":path": "/?client=pc&clientVersion=1.0.0&t=1682095499766&body=%7B%22skuId%22%3A100055452449%2C%22cat%22%3A%229987%2C653%2C655%22%2C%22area%22%3A%2222_1930_49322_49423%22%2C%22shopId%22%3A%221000001952%22%2C%22venderId%22%3A1000001952%2C%22paramJson%22%3A%22%7B%5C%22platform2%5C%22%3A%5C%221%5C%22%2C%5C%22specialAttrStr%5C%22%3A%5C%22p0pp1pppppppp1ppppppppppppp%5C%22%2C%5C%22skuMarkStr%5C%22%3A%5C%2200%5C%22%7D%22%2C%22num%22%3A1%7D&uuid=122270672.1682083603645945876354.1682083604.1682085913.1682094015.3&appid=pc-item-soa&functionId=pc_detailpage_wareBusiness",
                # ":scheme": "https",
                # "accept": "*/*",
            ...
            # print(resp.headers)
            print(f"查询商品信息:{resp.status_code}.")
            if resp:
                ret = resp.json()
                shopId = ret["shopInfo"]["shop"]["shopId"]
                print(f"查询商品信息ok:{shopId}.")
                return resp
            # time.sleep(0.5)
        return resp
    ...
    def fetchItemDetail(self, skuId):
        ...
        try:
            ...
            if "yuyueInfo" in resp:
                detail["yushouUrl"] = resp["yuyueInfo"]["url"]
    ...
    def getItemStock(self, skuId, skuNum, areaId):
        ...
        try:
            ...
            rt = "stockInfo" in resp and resp["stockInfo"]["isStock"]
            return rt
            ...
            for item in items:
                if str(item["item"]["Id"]) == skuId:
                    ...
                    return self.changeCartSkuCount(
                        skuId, item["item"]["skuUuid"], skuNum, areaId
                    )
        # 不在购物车中
        return self.addCartSku(skuId, skuNum)
